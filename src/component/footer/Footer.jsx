...
const SocialShare = [
    {Social: <FaFacebookF /> , link: 'https://www.facebook.com/meepoong'},
    {Social: <FaInstagram /> , link: 'https://www.instagram.com/meepoonggroup/'},
]
                            ...
                            <div className="row">
                                <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                    <div className="ft-text">
                                        ...
                                        <p>Copyright © 2021 <Link to="/">Meepoong</Link>  Built with love in Bangladesh All rights reserved.</p>
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-3 col-md-6 col-sm-6 col-12 mt_md--40 mt_sm--40">
                                    <div className="footer-link">
                                        <h4>Say Hello</h4>
                                        <ul className="ft-link">
                                            <li>Email: <a href="mailto:admin@example.com">Meepoonggroup@gmail.com</a></li>
                                            <li>Phone: <a href="mailto:hr@example.com">0630828384</a></li>
                                        </ul>

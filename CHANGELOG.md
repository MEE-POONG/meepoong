...
## [1.2.0] 2020-06-12
### Bug fixing
- https://github.com/creativetimofficial/meepoong/issues/2 (changed the fonts import to `~assets/fonts` and also added assets path inside `jsconfig.json` file)
...
### Deleted dependencies
### Added dependencies
+ gulp@4.0.2 (for MEE POONG copyrights)
+ gulp-append-prepend@1.0.8 (for MEE POONG copyrights)
### Updated dependencies
```
...
- Added design from Paper Kit 2 by MEE POONG
